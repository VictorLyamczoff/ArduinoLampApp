...
private color c_light= color(51, 64, 88);
...
private int d_step_y = s_height+6;
...
// button settings
private int angleRadiusButton = 5;
private int d_angleRadiusButton = 5;

// ====================================== STEP =======================================
void uiResetStep(int y) {
  _pos_y = y;
}
void uiSetStep(int x) {
  _step_y = x;
}
void uiRestoreStep() {
  _step_y = d_step_y;
...
public void uiSetScale(float scale) {
  ...
  angleRadiusButton = int(d_angleRadiusButton * scale);
}
...
// ====================================== DIVIDER =======================================
public void Divider(int x, int y, int w, int h) {
  noStroke();
  fill(90, 90, 90);
  rect(x, y+_step_y/2, w, h, s_stroke/4);
}
public void Divider(int y, int w) {
  Divider((width-w)/2, y, w, s_stroke/2);
}
public void Divider(int w) {
  Divider((width-w)/2, uiStep(), w, s_stroke/2);
}
...
public float Slider(float value) {
  ...
  return Slider(0f, 255f, value, x, uiStep(), s_big, s_height);
}
...
public float Slider(float value, int x, int y) {
  return Slider(0f, 255f, value, x, y, s_big, s_height);
}

public float Slider(String label, float value, int x, int y) {
  return Slider(label, 0f, 255f, value, x, y, s_big, s_height);
}
...
public float Slider(float value, int x, int y, int w, int h) {
  return Slider(0f, 255f, value, x, y, w, h);
}
